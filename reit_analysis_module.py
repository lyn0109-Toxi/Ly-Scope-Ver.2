...
KO_TRANSLATIONS = {
    ...
    "Portfolio": "포트폴리오",
    "Guide": "가이드",
    "LY-STScope Ver.2 is an educational prototype. It does not provide investment, legal, tax, financial, accounting, or professional advice. Third-party market data remains subject to the terms of its providers.": "LY-STScope Ver.2는 교육용 프로토타입입니다. 투자, 법률, 세무, 금융, 회계 또는 전문 조언을 제공하지 않습니다. 제3자 시장 데이터는 각 제공자의 약관을 따릅니다.",
}
...
def main(include_sidebar: bool = True) -> None:
    ...
    st.divider()
    st.caption(
        tr("LY-STScope Ver.2 is an educational prototype. It does not provide investment, legal, tax, financial, accounting, or professional advice. Third-party market data remains subject to the terms of its providers.")
    )
